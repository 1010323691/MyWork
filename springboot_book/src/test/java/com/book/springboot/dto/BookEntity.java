...
public class BookEntity {
	...
	public BookEntity(Integer bId, String bName, String bAuthor, String bPress, Integer bStock, Category bCategory) {
		super();
		this.bId = bId;
		this.bName = bName;
	...
	public String toString() {
		return "BookEntity [bId=" + bId + ", bName=" + bName + ", bAuthor=" + bAuthor + ", bPress=" + bPress
				+ ", bStock=" + bStock + ", bCategory=" + bCategory + "]";
	}
